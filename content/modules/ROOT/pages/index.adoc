...
|25 - 55 min |Workbench Creation & Model Quantization |Hands-On
a|- Hands-on: Step-by-step quantization of a model manually
- Int4
- Int8
- fp8

|55 - 75 min |Deploy Base and Optimized Model |Hands-On
...
|75 - 85 min |Pipeline Creation & Deployment |Hands-On
