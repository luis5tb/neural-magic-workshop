...
. In your already cloned repository ({git-clone-repo-url}) in your laptop, go to the folder with the lab material for this section (`neural-magic-workshop/lab-materials/03`)
...
[.bordershadow]
image::05/05-02-model-delete-optimized.png[]
