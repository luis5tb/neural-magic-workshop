...
+
[.bordershadow]
image::05/05-01-single-model.png[]
* Click on **Deploy model**
+
[.bordershadow]
image::05/05-01-deploy.png[]
...
+
[.bordershadow]
image::05/05-01-model-inputs.png[]
* Click on **Deploy** and wait for the model to be ready
+
[.bordershadow]
image::05/05-01-model-status.png[]
...
. Clone the repository ({git-clone-repo-url}) in your laptop and go to the folder with the lab material for this section (`neural-magic-workshop/lab-materials/03`)
...
+
[.bordershadow]
image::05/05-01-inference-endpoints.png[]
...
[.bordershadow]
image::05/05-01-model-delete.png[]
[.bordershadow]
image::05/05-01-model-delete-base.png[]
